          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-background">
              <div class="modal-header">
                <h5 class="modal-title" id="title">Customer Feedback</h5>
                  ...
                  <div class="container">
                    <div id="carouselContent" class="carousel slide" data-ride="carousel" data-interval="5000">
                      ...
                      <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item active text-center p-4">
                          <p><font style="font-style: italic;font-size: 22px;font-style: italic;font-family: times new roman, arial;">"This is the great IT company in my area.Best customer support.Im looking forward to doing business with them"</font></p>
                          <p>"Thomas Lakoo"</p>
                          
                        </div>
                        <div class="carousel-item text-center p-4">
                          
                          <p><font style="font-style: italic;font-size: 22px;font-style: italic;font-family: times new roman,arial;">"This is the great compnay to do business
                          with.The two guys are fabulous to work with"</font></p>
                          <p>"Tyler murphy"</p>
                        </div>
                        <div class="carousel-item text-center p-4">
                          <p><font style="font-style: italic;font-size: 22px;font-style: italic;font-family:times new roman, arial;">"This is the worse compnay to deal with.Customer service is a garbage"</font></p>
                          <p>"Jason Kenny"</p>
                        </div>
                        <div class="carousel-item text-center p-4">
                          <p><font style="font-style: italic;font-size: 22px;font-style: italic;font-family:times new roman, arial;">"This is the great IT company in my area.Best customer support.
                          Im looking forward to doing business with them"</font></p>
                          <p>"Rachel Nacho"</p>
                        </div>
                      </div>

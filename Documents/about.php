      ...
      <body>
        ...
        <div class="container">
          ...
          <p>Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah
            ...
            Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah<br>
          Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah
            Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah
            Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah
            Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="card text-center customcard"style="width: 18rem;">
                  <div class="card-body">
                    <img src="../images/Hari.jpg" alt="Hari koirala" class="img-fluid rounded-circle w-50 mb-4">
                    <h3 class="card-title">Hari Koirala</h3>
                    <h5>Lead director</h5>
                    <p>Soemthing something something soething something something</p>
                    <div class="d-flex flex-row justify-content-center">
                      <div class="p-4">
              ...
              <div class="col-sm-6">
                <div class="card text-center customcard"style="width: 18rem;">
                  <div class="card-body">
                    <img src="../images/Hari.jpg" alt="Ishor Bastola" class="img-fluid rounded-circle w-50 mb-4 ">
                    <h3 class="card-title">Ishor Bastola</h3>
